...
import pe.com.starcom.util.Message;
import pe.com.starcom.util.Seguridad;
import pe.com.starcom.util.StringUtils;
...
public class CambioClaveController implements Serializable {
	...
	public boolean validarDatos() throws Exception {
		...
		/*
		 * if (validarCuenta()) { FacesContext.getCurrentInstance().addMessage(
		 * null, new FacesMessage(FacesMessage.SEVERITY_WARN, "ADVERTENCIA",
		 * "Nombre de usuario / contraseña ya existe")); return false; }
		 */
